...
var Nav = __webpack_require__(8469);
...
const Program = ({ limit , className  })=>{
    ...
    async function fetchMyAPI(older) {
        const res2 = await fetch(`/api/proxy?url=https://pr0gramm.com/api/items/get?flags=1&promoted=1${older ? `&older=${older}` : ""}`);
...
var __webpack_exports__ = __webpack_require__.X(0, [210,835,725,27,469], () => (__webpack_exec__(3339)));
