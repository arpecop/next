...
function FBLogin({ app }: { app: FbApp }) {
	...
	const handleLoginClick = () => {
		...
		const redirectUri = "https://localhost:3001/fb/";
	...
	return (
		<button
			className="btn  border-0 text-white w-fit transition duration-300 undefined false false"
