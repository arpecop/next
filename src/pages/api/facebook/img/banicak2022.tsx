...
export default async function handler(req: NextRequest) {
	try {
      ...
      `,
		...
		// if (isFromOtherUser) {
		//   chatBubbleStyles.background = "#f1f0f0";
		//   beforeStyles.borderRightColor = "transparent";
		//   beforeStyles.borderLeftColor = "#f1f0f0";
		//   beforeStyles.right = "-0.5rem";
		// } else {
		//   beforeStyles.borderRightColor = "white";
		//   beforeStyles.left = "-0.5rem";
		// }
		...
		return new ImageResponse(
			(
				...
				>
					...
					<div style={{ fontSize: 20 }}>www.kloun.lol</div>
					<div
						style={{
							display: "flex",
							flexDirection: "column",
					...
					>
						{remappedJokeFunction(joke).map((x) => {
							return (
								<div
									key={x.key}
									style={{
								...
								>
									{x.oddness ? (
										<>
											<div
												style={{
													...(x.oddness === "odd" ? normalUser : replyUser),
												}}
											>
												{x.line}
											</div>
