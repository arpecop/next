...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5810);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7775)), "/home/runner/work/next/next/app/loading/[categorySlug]/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 550)), "/home/runner/work/next/next/app/loading/loading.tsx"],
    ...
    const pages = ["/home/runner/work/next/next/app/loading/[categorySlug]/page.tsx"];
...
const fetchCategory = async (categorySlug)=>{
    ...
    return await (0,_lib_getCategories__WEBPACK_IMPORTED_MODULE_3__/* .fetchCategoryBySlug */ .Ev)(categorySlug);
};
function Page({ params  }) {
    const category = (0,react__WEBPACK_IMPORTED_MODULE_1__.use)(fetchCategory(params.categorySlug));
...
var __webpack_exports__ = __webpack_require__.X(0, [225,202,483,463,715], () => (__webpack_exec__(6851)));
